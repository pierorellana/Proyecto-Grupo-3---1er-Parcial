      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            // ),
            //Image.asset('assets/cargando_captcha.gif', width: 100,),
            // SvgPicture.asset(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        //SvgPicture.asset(AppTheme.iconErrorPath),
        SizedBox(height: size.height * 0.03),
        titleAlerts(title: '¡Oops, algo fallo!', color: AppTheme.red),
        SizedBox(height: size.height * 0.04),
        messageAlerts(size, message: message),
        SizedBox(height: size.height * 0.03),
        FilledButtonWidget(
...
class AlertProfile extends StatefulWidget {
  ...
  @override
  State<AlertProfile> createState() => _AlertProfileState();
}
    ...
    return Stack(
      children: [
        Positioned(
          ...
          child: Center(
            child: CustomPaint(
              painter: HalfCircleLinePainter(color: Colors.black12, width: 0.5),
              child: Container(
                decoration: const BoxDecoration(
                  boxShadow: [
                    BoxShadow(
                      spreadRadius: -6,
                      color: Color.fromARGB(70, 101, 20, 20),
                      blurRadius: 10,
                      offset: Offset(0, -6),
                    ),
                  ],
...
class HalfCircleLinePainter extends CustomPainter {
  final Color color;
  final double width;

  HalfCircleLinePainter({required this.color, required this.width});
  ...
  @override
  bool shouldRepaint(HalfCircleLinePainter oldDelegate) => false;
}

class AlertProfileOverlay extends StatelessWidget {
  final Widget customPaint;
  final Widget content;

  const AlertProfileOverlay({
    Key? key,
